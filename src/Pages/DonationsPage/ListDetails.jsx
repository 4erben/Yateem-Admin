...
export default function ListDonationDetails() {
    const transferData = [
    ...
    <Container className=''>
        <div className='card py-4'>
            ...
            <Row className='my-3 px-3'>
                ...
                <Col lg={2}>
                    <select defaultValue="تصنيف التبرع">
                        <option value="تصنيف التبرع">تصنيف التبرع</option>
