    ...
    <Container className='financialReport'>
        <div className='card py-4'>
            <div className='d-flex justify-content-between px-2' >
                <h5 className='px-4'>الروابط المؤرشفة</h5>
                <button className='btn btn-danger mx-2'><IoMdCloseCircle /> حذف الروابط المحددة</button>
            </div>
            <Row> 
            ...
            <Row className='my-3 px-3 justify-content-between'>
                <Col lg={3}><Form.Control type='text' placeholder='ابحث' /></Col>
